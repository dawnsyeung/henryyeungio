const songs = [
  ...
  },
  {
      ...
      },
    {
      ...
      genre: "classical",
      mood: "Romantic strings",
      description: "Swelling violins and tender woodwinds usher in a gentle sunrise.",
      audio: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-11.mp3",
      accent: "linear-gradient(120deg, #fdfcfb, #e2d1c3)",
    },
    {
      id: "classical-02",
      title: "Midnight Chamber",
      artist: "Velorum Quartet",
      genre: "classical",
      mood: "Neo-classical pulse",
      description: "A restless ostinato beneath luminous piano figures and harp flurries.",
      audio: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-12.mp3",
      accent: "linear-gradient(120deg, #c9ffbf, #ffafbd)",
    },
    {
      id: "classical-03",
      title: "Celestial Reverie",
      artist: "Aurora Philharmonic",
      genre: "classical",
      mood: "Ambient symphonic",
      description: "Slow-moving brass choirs bloom over shimmering choral beds.",
      audio: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-13.mp3",
      accent: "linear-gradient(120deg, #d4fc79, #96e6a1)",
    },
];
